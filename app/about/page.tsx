...
export default function About() {
  return <PageShell>
    ...
    <section className="ari-section"><div className="ari-portrait" aria-label="Ari Cohen founder profile placeholder"><span>AC</span><small>FOUNDER / OPERATOR</small></div><div><p className="eyebrow">Meet Ari</p><h2>I built Kanary around the part of sales I know best.</h2><p>I&apos;m Ari Cohen, founder of Kanary Calling. I have spent my career in outbound sales learning how to turn a cold account into a real conversation.</p><p>I built Kanary for companies that need more of those conversations but do not need another full-time salesperson.</p><div className="ari-manifesto"><span>Understand the business.</span><span>Understand the buyer.</span><span>Pick up the phone.</span><span>Find the opportunity.</span></div><Link className="button" href="/contact">Start a conversation ↗</Link></div></section>
    <section className="why-kanary"><div className="why-mark"><span>K</span></div><div><p className="eyebrow">The signal in the name</p><h2>Why the canary?</h2><p>Historically, canaries were signals. Kanary Calling is built around the same idea.</p><p>Every cold call gives you one: interested, wrong person, wrong timing, real pain, or real opportunity.</p><p><strong>Our job is to find the signals worth acting on.</strong></p></div></section>
    <CtaBand />
  </PageShell>;
}
